        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <select 
              ...
              className="bg-white/20 text-white border border-white/30 rounded-md px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-white"
            >
            ...
            <button 
              ...
              className="bg-white/20 hover:bg-white/30 text-white px-4 py-1 rounded-md text-sm border border-white/30 transition-colors"
            >
              {viewMode === "charts" ? "Table View" : "Chart View"}
            </button>
            <button 
              onClick={() => setShowConfigModal(true)}
              className="bg-white text-sky-800 hover:bg-sky-100 px-4 py-1 rounded-md text-sm font-medium shadow transition-colors"
            >
              Configure Metrics
            </button>
          </div>
          ...
          <div key={index} className="bg-white rounded-xl shadow-sm p-6 border border-sky-100 hover:shadow-md transition-shadow">
            ...
            <div className="flex items-end justify-between">
              <span className="text-2xl font-bold text-sky-900">
                {metric.series[0].data[metric.series[0].data.length - 1]}
